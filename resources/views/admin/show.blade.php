                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <section class="text-gray-600 body-font relative">
                                ...
                                <div class="ml-16 mx-auto">
                                    ...
                                    <div class="p-2 mx-auto">
                                        <div class="relative">
                                            ...
                                            <p class="text-lg font-semibold">{{ $admin->age }}</p>
                                        </div>
                                    </div>
                                    <div class="p-2 mx-auto">
                                        <div class="relative">
                                    ...
                                    <div class="p-2 mx-auto">
                                        <div class="relative">
                                            ...
                                            <p class="text-lg font-semibold">{{ $admin->department->name }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="-mt-10 text-right">
                            <form id="delete_{{$admin->id}}" method="post" action="{{ route('admin.admin.destroy', [ 'admin' => $admin->id ]) }}">
                                @csrf
                                @method('DELETE')
