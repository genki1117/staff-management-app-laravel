                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 py-4 mx-auto text-right">
                            <button onclick="location.href='{{ route('admin.admin.create') }}'" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                新規登録
                            </button>
                            ...
                            <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                    ...
                                    @foreach ($admins as $admin)
                                        ...
                                        <td class="px-4 py-3">{{ $admin->department->name }}</td>
                                        <td class="px-4 py-3">
