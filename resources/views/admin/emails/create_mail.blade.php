                    ...
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 mx-auto">
                            ...
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                ...
                                <form method="post" action="{{ route('admin.admin_confirm_mail') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="-m-2">
                                        <div class="p-2 mx-auto">
                                            <div class="relative">
                                                <p class="leading-7 text-lg font-semibold text-gray-600">form</p>
                                                <input type="hidden" name="from" value="{{ $login_admin->email }}">
                                                <h4>{{ $login_admin->email }}</h4>
                                            </div>
                                            <div class="relative">
                                                <p class="leading-7 text-lg font-semibold text-gray-600 mt-4">to</p>
                                                <input type="hidden" name="to" value="{{ $admin->email }}">
                                                <h4>{{ $admin->email }}</h4>
                                            </div>
                                            <div class="relative">
