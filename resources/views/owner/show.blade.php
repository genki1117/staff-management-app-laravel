                    ...
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 mx-auto">
                                ...
                                <div class="ml-16 mx-auto">
                                    ...
                                    <div class="p-2 mx-auto">
                                        <div class="relative">
                                            ...
                                            <a href="{{ route('owner.owner_create_mail', $owner->id) }}"><i class="fa-solid fa-envelope pt-2 ml-2"></i></a>
                                        </div>
                                    </div>
                                    <div class="p-2 mx-auto">
                                        <div class="relative">
                            ...
                            <div class="mt-12 p-2 w-full flex justify-around">
                                ...
                                <button type="button" onclick="location.href='{{ route('owner.owners.edit', $owner->id) }}'" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">編集する</button>
                            </div>
                        </div>
                        <div class="-mt-10 text-right">
                            <form id="delete_{{$owner->id}}" method="post" action="{{ route('owner.owners.destroy', [ 'owner' => $owner->id ]) }}">
                                @csrf
                                @method('DELETE')
