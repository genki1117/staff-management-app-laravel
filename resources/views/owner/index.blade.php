                                ...
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                    ...
                                    @foreach ($owners as $owner)
                                        ...
                                        <td class="md:px-4 py-3">
                                            ...
                                            <button onclick="location.href='{{ route('owner.owners.show', $owner->id) }}'" class="text-white bg-indigo-400 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-500 rounded">
                                                詳細
                                            </button>
                                        </td>
                                    </tr>
