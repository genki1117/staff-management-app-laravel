                    ...
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 mx-auto">
                            <div class="flex flex-col text-center w-full mb-12">
                                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">オーナー詳細</h1>
                            </div>
                                ...
                                <div class="ml-16 mx-auto">
                                    ...
                                    <div class="p-2 mx-auto">
                                        <div class="relative">
                                            ...
                                            <a href="{{ route('owner.user_create_mail', $user->id) }}"><i class="fa-solid fa-envelope pt-2 ml-2"></i></a>
                                        </div>
                                    </div>
                                    <div class="p-2 mx-auto">
                                        <div class="relative">
                            ...
                            <div class="mt-12 p-2 w-full flex justify-around">
                                ...
                                <button type="button" onclick="location.href='{{ route('owner.users.edit', $user->id) }}'" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">編集する</button>
                            </div>
                        </div>
